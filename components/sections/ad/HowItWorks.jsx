...
import { Globe2, Database, Link2, BellRing, Zap, ArrowRight } from "lucide-react";
...
export default function HowItWorks() {
  ...
  const steps = [
    {
      id: "collect",
      phase: t("ad.howItWorks.steps.0.phase"),
      icon: Globe2,
      title: t("ad.howItWorks.steps.0.title"),
      desc: t("ad.howItWorks.steps.0.description")
    },
    {
      id: "enrich",
      phase: t("ad.howItWorks.steps.1.phase"),
      icon: Database,
      title: t("ad.howItWorks.steps.1.title"),
      desc: t("ad.howItWorks.steps.1.description")
    },
    {
      id: "correlate",
      phase: t("ad.howItWorks.steps.2.phase"),
      icon: Link2,
      title: t("ad.howItWorks.steps.2.title"),
      desc: t("ad.howItWorks.steps.2.description")
    },
    {
      id: "alert",
      phase: t("ad.howItWorks.steps.3.phase"),
      icon: BellRing,
      title: t("ad.howItWorks.steps.3.title"),
      desc: t("ad.howItWorks.steps.3.description")
    },
    {
      id: "remediate",
      phase: t("ad.howItWorks.steps.4.phase"),
      icon: Zap,
      title: t("ad.howItWorks.steps.4.title"),
      desc: t("ad.howItWorks.steps.4.description")
    },
  ];
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 text-blue-600 text-[10px] font-bold uppercase tracking-widest mb-4 border border-blue-100">
            {t("ad.howItWorks.badge")}
          </span>
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900 mb-6">
            {t("ad.howItWorks.title")} <span className="text-blue-600">{t("ad.howItWorks.titleHighlight")}</span>
          </h2>
          <p className="text-lg text-slate-500 leading-relaxed">
            {t("ad.howItWorks.description")}
          </p>
        </div>
