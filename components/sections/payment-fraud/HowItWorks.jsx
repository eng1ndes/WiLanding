...
import { Bookmark, Radar, Terminal, BellRing, ChevronRight } from "lucide-react";

const STEPS = [
  {
    icon: Bookmark,
    title: "Define your BIN watchlist",
    desc: "Add the BIN-6 and BIN-8 prefixes for the cards you issue or accept. Up to 256 BINs per account.",
  },
  {
    icon: Radar,
    title: "We monitor continuously",
    desc: "Carding shops, underground markets, infostealer logs, and dark web channels. New compromised cards are indexed within hours of surfacing.",
  },
  {
    icon: Terminal,
    title: "Query in real time",
    desc: "UI search or API call returns a structured response with full enrichment (issuer, country, network, type, tier, expiry) and current validity.",
  },
  {
    icon: BellRing,
    title: "Alerted on new exposure",
    desc: "Email alerts the moment a card on a watchlisted BIN is detected as compromised. De-duplicated and severity-tiered.",
  },
];
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900 mb-6">
            From BIN watchlist to blocked transaction
          </h2>
          <p className="text-lg text-slate-600 leading-relaxed">
            You define what you care about. We do the monitoring, the enrichment, and the alerting.
          </p>
        </div>
