...
const stepMeta = [
  { id: "collect", phase: "Detect", icon: Globe2 },
  { id: "enrich", phase: "Detect", icon: Database },
  { id: "correlate", phase: "Prioritize", icon: Link2 },
  { id: "alert", phase: "Prioritize", icon: BellRing },
  { id: "remediate", phase: "Prevent", icon: Zap },
];
...
export default function HowItWorks() {
  ...
  const steps = stepMeta.map((meta, i) => ({
    ...meta,
    title: t(`enterprise.howItWorks.steps.${i}.title`),
    desc: t(`enterprise.howItWorks.steps.${i}.description`),
  }));
  return (
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 text-blue-600 text-[10px] font-bold uppercase tracking-widest mb-4 border border-blue-100">
            {t("enterprise.howItWorks.badge")}
          </span>
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900 mb-6">
            {t("enterprise.howItWorks.title")}
          </h2>
          <p className="text-lg text-slate-500 leading-relaxed">
            {t("enterprise.howItWorks.description")}
          </p>
        </div>
