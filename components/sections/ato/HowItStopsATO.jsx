...
import { Globe2, Database, Link2, BellRing, Zap, ChevronRight } from "lucide-react";

const stepIcons = [Globe2, Database, Link2, BellRing, Zap];
...
export default function HowItStopsATO() {
  const { t } = useTranslation("features");
  const steps = stepIcons.map((icon, i) => ({
    icon,
    title: t(`ato.howItWorks.steps.${i}.title`),
    desc: t(`ato.howItWorks.steps.${i}.description`),
  }));
  return (
